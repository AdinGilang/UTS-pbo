...
public class BukuMain {
    ...
    public static void main(String[] args) {
        ...
        daftarBuku.add(new Fiksi("To Kill a Mockingbird"));
        daftarBuku.add(new Fiksi("Harry Potter and the Sorcerer's Stoned"));
        daftarBuku.add(new Fiksi("The Hunger Games"));
